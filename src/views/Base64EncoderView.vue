...
const decode = () => {
  ...
  if (!input.value.trim()) {
    error.value = 'Please enter Base64 text to decode'
    return
  }
  ...
  try {
    ...
    error.value = `Decoding error: Invalid Base64 string`
  }
}
...
const loadSample = () => {
  if (mode.value === 'encode') {
    ...
    input.value = 'SGVsbG8sIFdvcmxkISBUaGlzIGlzIGEgQmFzZTY0IGVuY29kaW5nIGV4YW1wbGUu'
  }
  process()
}
</script>
...
<template>
  <div class="base64-encoder">
    <div class="page-header">
      ...
      <p class="page-description">Encode and decode text using Base64 encoding</p>
    </div>
